                 ...
                 <div class="d-flex justify-content-center">
                    ...
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <form action="detail.php">
                            ...
                            <button type="submit"  name="detail" style="border: 0px" class="btn btn-sm text-dark p-0" > 
                                View Detail
                            </button>
                        </form>
                        <form action="" method="post">
...
?>
   <li class="page-item"><a class="page-link" href="inde.php?page=<?=$pagLink?>"><?=$pagLink?></a></li>
<?php 
         $i++;
        }; 
        if($page<$total_pages){   
