        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">Cake</span>Zone</h1>
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-9">
                ...
                <form action="" method="get">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search for products" name="nama">
                        <div class="input-group-append">
                            <span class="input-group-text bg-transparent text-primary">
                                <button name="search"><img src="img/search.svg" alt=""></button>
                            </span>
                        </div>
                    </div>
            ...
            <div class="card-footer d-flex justify-content-between bg-light border">
                <form action="detail.php" >
                    <input type="hidden" name="data" value="<?=$row['nama']?>">
                        <button type="submit"  name="detail" style="border: 0px" class="btn btn-sm text-dark p-0" >View Detail</button>
                </form>
                <form action="" method="post">
                    <input type="hidden" name="datas" value="<?=$row['nama']?>">
                        <button type="submit"  name="cart" style="border: 0px" class="btn btn-sm text-dark p-0" >Add To Cart</button>
                </form>
            </div>
        </div>
    </div>                  
            ...
            <div class="card-footer d-flex justify-content-between bg-light border">
                ...
                <form action="" method="post">
                    <input type="hidden" name="datass" value="<?=$row['nama']?>">
                        <button type="submit"  name="carts" style="border: 0px" class="btn btn-sm text-dark p-0" >Add To Cart</button>
                </form>
            </div>
        </div>
    </div>                  
